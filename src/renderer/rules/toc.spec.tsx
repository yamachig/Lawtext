...
<div class="toc">
  <p class="toc-label indent-0">目次</p>
  <div class="toc-body">
    <div class="toc-item-TOCPreambleLabel">
      <p class="toc-item-main indent-1">前文</p>
    </div>
    <div class="toc-item-TOCArticle">
      <p class="toc-item-main indent-1">第一条都市計画法の施行期日</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第一章　総則（第一条―第四条）</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第二章　申請に対する処分（第五条―第十一条）</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第三章　不利益処分</p>
      <div class="toc-item-TOCSection">
        <p class="toc-item-main indent-2">第一節　通則（第十二条―第十四条）</p>
      </div>
      <div class="toc-item-TOCSection">
        <p class="toc-item-main indent-2">第二節　聴聞（第十五条―第二十八条）</p>
      </div>
      <div class="toc-item-TOCSection">
        <p class="toc-item-main indent-2">第三節　弁明の機会の付与（第二十九条―第三十一条）</p>
      </div>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第四章　行政指導（第三十二条―第三十六条の二）</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第四章の二　処分等の求め（第三十六条の三）</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第五章　届出（第三十七条）</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第六章　意見公募手続等（第三十八条―第四十五条）</p>
    </div>
    <div class="toc-item-TOCChapter">
      <p class="toc-item-main indent-1">第七章　補則（第四十六条）</p>
    </div>
    <div class="toc-item-TOCSupplProvision">
      <p class="toc-item-main indent-1">附則</p>
    </div>
  </div>
</div>
`;
