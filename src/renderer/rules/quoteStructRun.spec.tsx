...
`;
        const tempParsedHtml = path.join(tempDir, "renderer.quoteStructRun.html");
...
<w:r>
  <w:drawing>
    <wp:inline distT="0" distB="0" distL="0" distR="0">
      ...
      <wp:docPr id="17775" name="QuoteStruct7775"></wp:docPr>
...
`;
        ...
        const tempParsedDocx = path.join(tempDir, "renderer.quoteStructRun.docx");
