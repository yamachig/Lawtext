...
describe("Test virtualLine", () => {
    ...
    it("Success case", () => {
        ...
        const target: [
            ...
            [[LineType.OTH, 1, LineType.OTH, 1, +1], "  前文"],
            [[LineType.ART, 1, LineType.ART, 1, +0], "  第一条　都市計画法の施行期日"],
            [[LineType.ARG, 1, VirtualL.TAG, 1, +0], "  第一章　総則（第一条―第四条）"],
            ...
            [[LineType.BNK, 0, LineType.BNK, 0, +0], ""],
            [[LineType.OTH, 1, VirtualL.CAP, 0, +0], "  （聴聞の通知の方式）"],
            ...
            [[LineType.BNK, 0, LineType.BNK, 0, +0], ""],
            [[LineType.OTH, 1, VirtualL.CAP, 0, +0], "  （地方公共団体の措置）"],
            ...
            [[LineType.BNK, 0, LineType.BNK, 0, +0], ""],
            [[LineType.TBL, 0, LineType.TBL, 0, +0], "* - 項"],
            [[LineType.TBL, 1, LineType.TBL, 0, +0], "  - 種名"],
            [[LineType.BNK, 0, LineType.BNK, 0, +0], ""],
            [[LineType.SPR, 3, LineType.SPR, 0, +0], "      附　則"],
            [[LineType.BNK, 0, LineType.BNK, 0, +0], ""],
            [[LineType.OTH, 1, VirtualL.CAP, 0, +0], "  （施行期日）"],
            [[LineType.PIT, 0, LineType.PIT, 0, +0], "１　この法律は、公布の日から起算して一年を超えない範囲内において政令で定める日から施行する。"],
            [[LineType.BNK, 0, LineType.BNK, 0, +0], ""],
            [[LineType.OTH, 1, VirtualL.CAP, 0, +0], "  （経過措置）"],
