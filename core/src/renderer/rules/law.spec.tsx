...
import { DOCXLaw, HTMLLaw } from "./law.tsx";
...
`;
        const tempParsedHtml = path.join(ensureTempTestDir(), "renderer.law.html");
...
`;
        ...
        const tempParsedDocx = path.join(ensureTempTestDir(), "renderer.law.docx");
