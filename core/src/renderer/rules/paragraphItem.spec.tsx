...
`;
        const tempParsedHtml = path.join(ensureTempTestDir(), "renderer.paragraphItem.html");
...
`;
        ...
        const tempParsedDocx = path.join(ensureTempTestDir(), "renderer.paragraphItem.docx");
