...
import { AppdxItemHeadLine, BlankLine, LineType } from "../../../node/cst/line.ts";
...
import { isAppdxItemTitle, newStdEL, appdxItemTags, appdxItemTitleTags, isRelatedArticleNum, isRemarks, isFigStruct, isTableStruct, isNoteLikeStruct, isArithFormula, isParagraphItem } from "../../../law/std/index.ts";
...
import { detectAppdxItemTitle } from "../../cst/rules/$appdxItemHeadLine.ts";
import { sentenceChildrenToString } from "../../cst/rules/$sentenceChildren.ts";
import { appdxItemControls, autoTagControls } from "../../cst/rules/$tagControl.ts";
