...
import { $noteStruct, noteLikeStructToLines } from "./$noteLike.ts";
...
備考　
  ...
  :ignore-title:一　路程の計算については、
  :ignore-title:二　水路及び陸路四分の一キロメートルをもつて鉄道一キロメートルとみなす。
        ...
        const expectedValue = {
            ...
            children: [
                ...
                },
                {
                    tag: "Sentence",
                    attr: {},
                    children: ["一　路程の計算については、"],
                },
                {
                    tag: "Sentence",
                    attr: {},
                    children: ["二　水路及び陸路四分の一キロメートルをもつて鉄道一キロメートルとみなす。"],
                },
            ],
        };
