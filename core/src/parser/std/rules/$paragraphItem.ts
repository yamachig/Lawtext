...
import { ArticleLine, BlankLine, LineType, OtherLine, ParagraphItemLine } from "../../../node/cst/line.ts";
...
import type { AttrEntries, SentenceChildEL } from "../../../node/cst/inline.ts";
import { AttrEntry, Control, Sentences } from "../../../node/cst/inline.ts";
import type { WithErrorRule } from "../util.ts";
import { $optBNK_INDENT, captionControl, isSingleParentheses, makeIndentBlockWithCaptureRule } from "../util.ts";
import type { VirtualLineRuleFactory } from "../factory.ts";
...
import { paragraphItemTitleMatch, paragraphItemTitleRule, unknownParagraphItemTitleMatch } from "../../cst/rules/$paragraphItemLine.ts";
import { anonymParagraphItemControls, autoTagControls, paragraphItemControls } from "../../cst/rules/$tagControl.ts";
import { circledDigitChars, parseNamedNum } from "../../../law/num.ts";
