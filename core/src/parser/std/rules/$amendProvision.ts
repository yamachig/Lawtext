...
import { isAmendProvision, isAmendProvisionSentence, isAppdxItem, isArticle, isArticleGroup, isArticleGroupTitle, isFigStruct, isLawTitle, isList, isNewProvision, isNoteLikeStruct, isPreamble, isRemarks, isSupplNote, isSupplProvisionAppdxItem, isTableStruct, isTOC, newStdEL } from "../../../law/std/index.ts";
