...
### LawtextコアライブラリのCLI、技術的詳細

- LawtextコアライブラリのCLIについては、[`CLI usage` ページ](../cli.mdx)をご覧ください。
- Lawtextコアライブラリの技術的詳細については、[`Technical details` ページ](../technical/index.mdx)をご覧ください。
...
Law is one of the most influential document types, drawing interest from legal, business, and academic areas. It is considered that the text of the law and changes in the law should be open and transparent, and editing law should not allow any mistakes.
...
- [Standard law XML](https://laws.e-gov.go.jp/help/#about-xml-format) (released in May 2017), standardized paragraph-level markup format for Japanese laws. Most of the major Japanese laws are now made public as standard law XML (in addition to HTML already available).
...
### The CLI and the technical detail of the Lawtext core library

- For the Lawtext core library CLI, please visit the [`CLI usage` page](../cli.mdx).
- For the technical detail of the Lawtext core library, please visit the [`Technical details` page](../technical/index.mdx).
