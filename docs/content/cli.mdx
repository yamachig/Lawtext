...
- Run `lawtext = await import("...")` (replace `...` with the copied URL of [lawtext.js](/static/lawtext_bundles/browser/lawtext.js)) in the browser console.
- Run `console.log(lawtext.run.help)` in the browser console.
...
- Download the prebuilt bundle from here: [lawtext_cli.mjs](/static/lawtext_bundles/node/lawtext_cli.mjs)
- Run `node lawtext_cli.mjs --help`
