...
The parser rule is defined at [`$pointerRanges`](../lib/core/src/parser/cst/rules/$pointerRanges/README.mdx#pointerranges). The detected pointers will be resolved later to refer to the actual clauses.
