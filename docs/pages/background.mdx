...
- For the Lawtext core library, the CLI, and the technical details of Lawtext, please visit the [`core` directory](https://github.com/yamachig/Lawtext/tree/main/core).
