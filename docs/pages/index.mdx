...
<div style={{textAlign: "center"}}>
  <a
    ...
    style={{display: "inline-block", border: "1px solid currentColor", padding: "0.5em",borderRadius: "0.5em"}}
    target="_blank"
    rel="noopener"
  >
  試してみる / Try it
...
Lawtextのコアライブラリ、CLI、技術的詳細は、[`core` フォルダ](https://github.com/yamachig/Lawtext/tree/main/core)をご覧ください。
...
- For the Lawtext core library, the CLI, and the technical detail of Lawtext, please visit the [`core` directory](https://github.com/yamachig/Lawtext/tree/main/core).
